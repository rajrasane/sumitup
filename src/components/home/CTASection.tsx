                ...
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                    ...
                    <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center">
                        <div>
                            <Button 
                                variant={'link'} 
                                className="w-full min-[400px]:w-auto bg-linear-to-r from-slate-900 to-rose-500 hover:from-rose-500 hover:to-slate-900 hover:text-white text-white transition-all duration-300 hover:no-underline hover:scale-105 hover:transition-all"
                                size={"lg"}
                            >
                                <Link 
                                    href='/#pricing' 
                                ...
                                >
                                    Get Started <ArrowRight size={18} className="ml-2 h-4 w-4 animate-pulse"/>
                                </Link>
                            </Button>
                        </div>
                    </div>
